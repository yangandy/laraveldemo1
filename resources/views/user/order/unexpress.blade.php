            ...
            <table class="cartTable">
                ...
                @foreach($items as $item)
                    ...
                    <tr>
                        ...
                        <td class="col-sm-1 col-md-1 text-center" >
                            <span ><strong>{{$item->status($item->status)}}</strong> </span></td>



                        <td class="col-sm-1 col-md-1 text-center">
                            <a href="./{{$item->status}}/{{$item->id}}"> <button type="button" class="btn btn-danger">
                                    <span class="fa fa-remove">{{$item->caozuo($item->status)}}</span>
